...
void NavWidget::initializeUi()
{
    ...
    // d->navBackButton->setIcon(QIcon::fromTheme("go-previous"));
    // d->navBackButton->setIconSize(QSize(12, 12));
    ...
    // d->navForwardButton->setIcon(QIcon::fromTheme("go-next"));
    // d->navForwardButton->setIconSize(QSize(12, 12));
