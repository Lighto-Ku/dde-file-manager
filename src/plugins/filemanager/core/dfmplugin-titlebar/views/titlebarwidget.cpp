...
void TitleBarWidget::initTabBar(const quint64 windowId)
{
    ...
    // connect(newTabButton, &DIconButton::clicked, this, &TitleBarWidget::onAddNewTabButtonClicked);
}
...
void TitleBarWidget::initializeUi()
{
    ...
    topBarCustomLayout->addSpacing(10);
    topBarCustomLayout->addWidget(curNavWidget, 0, Qt::AlignLeft);
...
TabBar *TitleBarWidget::createTabBar(const quint64 windowId)
{
    ...
    connect(tabBar, &TabBar::tabAddableChanged, this, &TitleBarWidget::onTabAddableChanged);
    return tabBar;
}

// void TitleBarWidget::onAddNewTabButtonClicked()
// {
...
//     TabBarManager::instance()->openNewTab(winId, url);
// }

void TitleBarWidget::onTabAddableChanged(bool addable)
{
